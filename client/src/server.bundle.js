...
/***/ function(module, exports, __webpack_require__) {
	...
	app.get('/dist/js/vendor.dll.js', function (req, res) {
	    res.sendFile('/vendor.dll.js', { root: __dirname + '/../dist/js' });
	});

	app.get('/dist/js/client.bundle.js', function (req, res) {
	...
	var storePage = function storePage(html, initialState) {
	    return '\n        <!doctype html>\n        <html lang="utf-8">\n            <head>\n                <script>\n                    window.__state__ = ' + (0, _stringify2.default)(initialState) + ';\n                </script>\n            </head>\n            <body>\n                <div id="root" >' + html + '</div>\n            </body>\n            <script src="/dist/js/vendor.dll.js"></script>\n            <script src="/dist/js/client.bundle.js"></script>\n        </html>\n    ';
	};
	...
	module.exports = {
	  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
	    function(test, buggy, set){
	      try {
	        set = __webpack_require__(9)(Function.call, __webpack_require__(110).f(Object.prototype, '__proto__').set, 2);
	        set(test, []);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _rightMenu = __webpack_require__(124);
	...
	var _ueditor = __webpack_require__(131);

	var _ueditor2 = _interopRequireDefault(_ueditor);

	var _articleList = __webpack_require__(132);

	var _articleList2 = _interopRequireDefault(_articleList);

	var _articleInfo = __webpack_require__(134);
	...
	var _list3 = __webpack_require__(141);

	var _list4 = _interopRequireDefault(_list3);

	var _regForm = __webpack_require__(142);

	var _regForm2 = _interopRequireDefault(_regForm);

	var _loginForm = __webpack_require__(143);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _waveCanvas = __webpack_require__(126);
	        ...
	        if (this.props.data) {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { id: 'authorarea' },
	                    _react2.default.createElement('img', { alt: '\u5934\u50CF', src: __webpack_require__(135), className: 'avatar avatar-100 photo', height: '100', width: '100' }),
	                    _react2.default.createElement(
	                        'h3',
	                        null,
	                        '\u5173\u4E8E ',
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(
	                                    ...
	                                    _react2.default.createElement('img', { alt: '\u5934\u50CF', src: __webpack_require__(138), className: 'avatar avatar-80 photo avatar-default', height: '80', width: '80' }),
	                                    _react2.default.createElement(
	                                        'b',
	                                        { className: 'fn' },
	                                        _react2.default.createElement(
