...
const RightMenu = React.createClass({
    ...
    render() {
        var classObj = this.props.isOpen ? 'stmenu isOpen':'stmenu';
                ...
                <aside id="secondary" className="widget-area" role="complementary">
                    <section id="search-2" className="widget widget_search">
                        <form role="search" method="get" className="search-form" action="/search">
                            <label>
                                <input type="search" className="search-field" placeholder="搜索&hellip;" value="" name="keyword"/>
                            </label>
                            <input type="submit" className="search-submit" value="搜索"/>
                        </form>
                    </section>
                    <section id="recent-posts-2" className="widget widget_recent_entries"><h2 className="widget-title">近期文章</h2>
                        <ul>
                        </ul>
                    </section>
                    <section id="recent-comments-2" className="widget widget_recent_comments"><h2 className="widget-title">近期评论</h2>
                        <ul id="recentcomments">
                        </ul>
                    </section>
                    <section id="categories-2" className="widget widget_categories"><h2 className="widget-title">分类目录</h2>
                        <ul>
                    ...
                    <section id="meta-2" className="widget widget_meta">
                        ...
                        <ul>
                            ...
                            <li><a target="_blank" href="http://www1.w3cfuns.com/tools.php?mod=compression">js/css压缩</a></li>
